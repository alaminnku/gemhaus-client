import styles from './OutStory.module.css';
  ...
  return (
    <section className={styles.container}>
      ...
      <p>
        ...
        brokerage that doesn't just keep pace with industry shifts but leads the
        way. We understand that success in real estate requires expertise,
        adaptability, and a commitment to meeting the unique needs of our
        clients.
      </p>
      <p>
        Our journey is driven by the belief that the future of real estate is an
        ever-evolving landscape where innovation meets tradition, and where
        personalized service thrives alongside cutting-edge technology. We're
        here to guide you through this exciting journey, offering a new paradigm
        for real estate that redefines what's possible.
      </p>
    </section>
  );
}
